...
describe('DeepSeekProvider', function () {
    beforeEach(function () {
        $this->provider = new TestableDeepSeekProvider('test-api-key');
    });
    ...
    describe('construction', function () {
        ...
        it('returns deepseek as name', function () {
            expect($this->provider->getName())->toBe('deepseek');
        });
    });
    ...
    describe('chat', function () {
        ...
        it('overrides model and options from parameters', function () {
            ...
            expect($this->provider->lastPayload['model'])->toBe('deepseek-reasoner');
